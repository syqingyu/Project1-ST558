...
The conitigency table below shows that the data for each race and sex have equal counts of estimates. **This table looks confusing to me. All the row and column shows same number. What's the significance here?**
...
g+ geom_point(size = 0.5, alpha = 0.6)+
  geom_smooth(aes(group=Race), method = lm, col="black") + labs(y="Life Expectancy") + ggtitle("Life Expectancy ariation from 1900 to 2015")
```
**Good Work**