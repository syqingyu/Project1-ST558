...
After we have downloaded the JSON file from the above mentioned link we have examined it in the firefox[Web Browser]. The JSON has a metadata portion along with the data segment.
